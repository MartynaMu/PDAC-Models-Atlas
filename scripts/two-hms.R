  ...
  output$hm_plot <- renderPlotly({
    ...
    subplot(p_ann1,
      ...
      layout(height = plot_height,
             ...
             annotations = list(
               list(
                 x = 7.5, y = 2, text = "First Heatmap", showarrow = FALSE, align = "center",
                 xref = "x0", yref = "paper", font = list(size = 16)
               ),
               list(
                 x2 = 7.5, y = 1, text = "Second Heatmap", showarrow = FALSE, align = "center",
                 xref = "x2", yref = "paper", font = list(size = 16)
               )
             ))
